...
use Closure;
use Amu\Reemote\Exception\ConnectionFailureException;
...
class Connection implements ConnectionInterface {
     ...
     *
     * @var \Amu\Reemote\Gateway\GatewayInterface
     */
    protected $gateway;
     ...
     *
     * @var \Amu\Reemote\Output\OutputInterface
     */
    protected $output;
     ...
     * @param  array   $auth
     * @param  \Amu\Reemote\Gateway\GatewayInterface
     */
    public function __construct($name, $host, $username, array $auth, GatewayInterface $gateway = null)
    {
        ...
        $this->gateway = $gateway ?: new SecLibGateway($host, $auth);
    }
     ...
     *
     * @return \Amu\Reemote\GatewayInterface
     *
    ...
    public function getGateway()
    {
        ...
        {
            throw new ConnectionFailureException("Unable to connect to remote server.");
        }
     ...
     *
     * @return \Amu\Reemote\Output\OutputInterface
     */
     ...
     *
     * @param  \Amu\Reemote\Output\OutputInterface  $output
     * @return void
     */
